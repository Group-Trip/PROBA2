import { ArrowLeft, Ticket, Gift, TrendingUp, Settings, LogOut, Crown, Calendar } from "lucide-react";
...
export function ProfileScreen({ onNavigate }: ProfileScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-6 pb-24">
