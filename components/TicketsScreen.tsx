...
import { ArrowLeft, Download, Share2, Ticket as TicketIcon, Calendar, MapPin, Clock, User } from "lucide-react";
...
export function TicketsScreen({ onNavigate, groupId }: TicketsScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-6 pb-8">
